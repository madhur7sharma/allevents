...
export default function Workshop() {
    ...
    const urlALL = 'https://allevents.s3.amazonaws.com/tests/workshops.json'
    ...
    if(product)
    {
        const WorkshopEvents = product.item.map((item , pos) => {
            return(
                <>
                    ...
                    <>
                        {
                            product.item.map((item,pos) => {
                                ...
                                {
                                    return(
                                        <div className="flex flex-col text-center rounded-lg shadow border-solid border-2 border-blue-200 mx-10 my-10 p-10 mt-56 items-center" key={pos}>
                                            <div>
