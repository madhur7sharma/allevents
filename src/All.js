...
export default function All() {
    ...
    const urlALL = 'https://allevents.s3.amazonaws.com/tests/all.json'
    ...
    if(product)
    {
        const AllEvents = product.item.map((item , pos) => {
            return(
                <>
                    <div className="flex flex-col flex-warp items-center w-72 h-96 bg-blue-100 rounded-2xl overflow-hidden" key={item.event_id}>
                        <div className="p-2">
